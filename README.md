...
- Output the top 3 users who have posts with the highest average number of comments per post. This metric would essentially be the ratio of the total comments on their post to the number of posts. 
